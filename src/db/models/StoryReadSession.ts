...
export type StoryReadSessionDoc = mongoose.InferSchemaType<
  typeof StoryReadSessionSchema
>;
export const StoryReadSession =
  mongoose.models.StoryReadSession ||
  mongoose.model("StoryReadSession", StoryReadSessionSchema);
